...
import com.lianzheng.management.login.modules.login.form.PasswordForm;
...
//		ValidatorUtils.validateEntity(user, UpdateGroup.class);
	...
	public ResponseBase getAction(String roleName){
		...
		//超级管理员全部可查看
		if (userRoleId == 1){
			notarialOfficeId = null;
		}
		List<SysUserEntity> sysUserEntityList =sysUserService.getUser(roleName,notarialOfficeId);
