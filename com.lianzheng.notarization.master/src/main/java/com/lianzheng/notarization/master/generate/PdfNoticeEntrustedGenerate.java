 ...
 * 生成办理委托公证告知书
 */
public class PdfNoticeEntrustedGenerate extends PdfNoticeGenerate{
    ...
    public PdfNoticeEntrustedGenerate(NotarzationMasterEntity notarzationMasterEntity) {
    ...
    public  void Generatefile(String sourceFile) throws Exception {
        String destinationDocFile= "notices/PDF_NOTICE_ENTRUSTED_" + notarzationMasterEntity.getProcessNo() + ".docx";
        String destinationPdfFile= "notices/PDF_NOTICE_ENTRUSTED_" + notarzationMasterEntity.getProcessNo() + ".pdf";
        String pdfFileName="PDF_NOTICE_ENTRUSTED_" + notarzationMasterEntity.getProcessNo() + ".pdf";
        //生成文件
        ...
        IuserDocumentService.deleteFileByCategoryCode(id, DocumentCategoryCode.PDF_NOTICE_ENTRUSTED.getCode());
        IuserDocumentService.addFile(destinationPdfFile, pdfFileName, id, DocumentCategoryCode.PDF_NOTICE_ENTRUSTED.getCode(),true);
    ...
    public  void GeneratefileFinal() throws Exception {
        String id =notarzationMasterEntity.getId();
        String destinationDocFile= IuserDocumentService.getDocx(id,DocumentCategoryCode.PDF_NOTICE_ENTRUSTED.getCode());
        String destinationPdfFile= "notices/PDF_NOTICE_ENTRUSTED_" + notarzationMasterEntity.getProcessNo() + ".pdf";
        String pdfFileName="PDF_NOTICE_ENTRUSTED_" + notarzationMasterEntity.getProcessNo() + ".pdf";
        ...
        IgeneratePdf.generatePdf(hashMap, destinationDocFile, destinationPdfFile, "", false);
        IuserDocumentService.deleteFileByCategoryCode(id, DocumentCategoryCode.PDF_NOTICE_ENTRUSTED.getCode());
        IuserDocumentService.addFile(destinationPdfFile, pdfFileName, id, DocumentCategoryCode.PDF_NOTICE_ENTRUSTED.getCode(),false);
    }
